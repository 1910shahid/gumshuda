...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<link href="css/cfpass.css" rel="stylesheet" type="text/css" media="all" />
...
<body>
					...
					<div class="logo_wthree_agile">
						...
						<h1>
							<a class="navbar-brand" href="index.html">
								<i aria-hidden="true"><img src="images/search.png"/></i>Gumshuda<br/>
								<span class="desc">Hope Never Ends</span>
							</a>
						</h1>
					</div>
				</div>
				<div id="navbar" class="navbar-collapse collapse">
					<div class="nav_right_top">
						<ul class="nav navbar-nav">
							...
							<li>
								<a class="scroll" href="login/login.php">Login/register</a>
							</li>
	...
	<!--//banner -->
			...
			<div class="col-md-3 donate-f-login">
					<div class="col-md-3 photo-grid text-center">
						<div class="dodecagon t1">
							<div class="dodecagon-in t1">
								<div class="dodecagon-bg t1"><br/><br/>
									<h3 class="tittle_w3_agileinfo">Login |<br/>Register</h3>
								</div>
							</div>
						</div>
	...
	<div class="banner_bottom" id="about">
		<div class="container">
			<h3 class="tittle_w3_agileinfo">About Gumshuda</h3>
			<div class="inner_sec_info_w3layouts">
				<div class="help_full">
					<ul class="rslides" id="slider4">
						<li>
							<div class="respon_info_img">
								<img src="images/banner3.jpg" class="img-responsive" alt="gumshuda">
							</div>
						...
						<li>
							<div class="respon_info_img">
								<img src="images/banner2.jpg" class="img-responsive" alt="Gumshuda">
							</div>
							<div class="banner_bottom_left">
						...
						<li>
							<div class="respon_info_img">
								<img src="images/banner1.jpg" class="img-responsive" alt="Gumshuda">
							</div>
							<div class="banner_bottom_left">
						...
						<li>
							<div class="respon_info_img">
								<img src="images/banner4.jpg" class="img-responsive" alt="gumshuda">
							</div>
							<div class="banner_bottom_left">
						...
						<div>
							<span class="image-block img-hover">
								<a class="image-zoom" href="images/g1.jpg" rel="prettyPhoto[gallery]">
									...
									<img src="images/g1.jpg" class="img-responsive" alt="gumshuda">
